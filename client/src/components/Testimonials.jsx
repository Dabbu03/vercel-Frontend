...
const Testimonials = () => {
    ...
    return (
        ...
        <motion.div
            ...
            className='flex flex-col-reverse items-center justify-center my-20 py-12'>
            ...
            <div className='testi flex flex-wrap gap-6'>
                {
                    testimonialsData.map((testimonail, index) => (
                        <div className='bg-white/20 p-12 rounded-lg shadow-md border w-80 m-auto cursor-pointer hover:scale-1.0.3 translate-all'
                            key={index}>
                            <div className='flex flex-col items-center'>
                                <img src={testimonail.image} alt="testi_img"
                                ...
                                <div className='flex mb-4'>
                                    {Array(testimonail.stars).fill().map((item, index) => (
                                        <img
                                            ...
                                            src={assets.rating_star} key={index} alt="" />
                                    ))}
                                </div>
